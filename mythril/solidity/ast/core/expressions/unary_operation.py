...
from mythril.solidity.ast.core.exceptions import StaticCoreError
from mythril.solidity.ast.core.expressions.expression_typed import ExpressionTyped
...
class UnaryOperationType(Enum):
    ...
    def is_prefix(operation_type):
        ...
        raise StaticCoreError(f"is_prefix: Unknown operation type {operation_type}")
