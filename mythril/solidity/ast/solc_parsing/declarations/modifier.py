...
from mythril.solidity.ast.core.cfg.node import link_nodes
...
if TYPE_CHECKING:
    ...
    from mythril.solidity.ast.core.declarations import Function
class ModifierSolc(FunctionSolc):
    def __init__(
        ...
        super().__init__(modifier, function_data, contract_parser, static_parser)
