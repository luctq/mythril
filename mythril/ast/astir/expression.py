...
from mythril.ast.core.expressions.assignment_operation import AssignmentOperation
from mythril.ast.core.expressions.binary_operation import BinaryOperation
...
from mythril.ast.core.expressions.new_array import NewArray
from mythril.ast.core.expressions.new_contract import NewContract
from mythril.ast.core.expressions.new_elementary_type import NewElementaryType
...
from mythril.ast.core.expressions.unary_operation import UnaryOperation
...
class ExpressionVisitor:
    ...
    # visit an expression
    # call visit_expression_name, post_visit
    def _visit_expression(self, expression: Expression): 
        ...
        if isinstance(expression, AssignmentOperation):
            ...
            raise StaticError(f"Expression not handled: {expression}")
