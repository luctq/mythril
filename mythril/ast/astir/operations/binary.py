...
from mythril.ast.astir.utils.utils import is_valid_lvalue, is_valid_rvalue
...
class BinaryType(Enum):
    ...
    def get_type(operation_type):  # pylint: disable=too-many-branches
        ...
        raise AstIRError(f"get_type: Unknown operation type {operation_type})")
    ...
    def __str__(self):  # pylint: disable=too-many-branches
        ...
        if self == BinaryType.OROR:
            return "||"
        raise AstIRError(f"str: Unknown operation type {self} {type(self)})")
