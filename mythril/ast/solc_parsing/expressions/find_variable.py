...
from mythril.ast.core.declarations.solidity_variables import SolidityFunction, SolidityVariable, SOLIDITY_VARIABLES, SOLIDITY_FUNCTIONS
...
from mythril.ast.core.declarations.function_top_level import FunctionTopLevel
from mythril.ast.core.declarations.solidity_import_placeholder import SolidityImportPlaceHolder
...
from mythril.ast.solc_parsing.exceptions import VariableNotFound
...
def _find_variable_init(
    ...
    from mythril.ast.solc_parsing.variables.top_level_variable import TopLevelVariableSolc
