...
from mythril.ast.core.variables.structure_variable import StructureVariable
from mythril.ast.solc_parsing.variables.structure_variable import StructureVariableSolc
