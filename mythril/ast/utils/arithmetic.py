...
from mythril.ast.utils.integer_conversion import convert_string_to_fraction
...
def convert_subdenomination(
    ...
    raise StaticException(f"Subdemonination conversion impossible {decimal_value} {sub}")
