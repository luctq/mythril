...
from mythril.ast.core.solidity_types import ArrayType, MappingType, ElementaryType, UserDefinedType
...
def convert_type_for_solidity_signature(t: Type, seen: Set[Type]) -> Union[Type, List[Type]]:
    ...
    from mythril.ast.core.declarations import Contract, Enum, Structure
...
def _export_return_type_from_variable(underlying_type: Type, all_types: bool) -> List[Type]:
    # pylint: disable=import-outside-toplevel
    from mythril.ast.core.declarations import Structure
